...
if(isset($_POST["submit"])){
  ...
  # code...
    ...
    Redirect_to("EditLesson.php?id=$SearchQueryParameter");
...
// insert query
    ...
    if (!empty($_FILES["Image"]["name"])) {
      $sql="UPDATE lesson 
      SET title='$PostTitle',subject='$Subject', image='$Image',post='$PostText',tag='$PostTag',description='$PostDescription'
      WHERE id='$SearchQueryParameter'";
        # code...
    }
    else {
      $sql="UPDATE lesson 
      SET title='$PostTitle',subject='$Subject',post='$PostText',tag='$PostTag',description='$PostDescription'
      WHERE id='$SearchQueryParameter'";
    }
    ...
    if ($Execute) {
     $_SESSION["SuccessMessage"]="Lesson Updated Successfully ";
     Redirect_to("EditLesson.php?id=$SearchQueryParameter");
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col align-self-center" id="header-div">
          <h3 class="text-light"><i class="fas fa-edit"></i> Edit Lesson</h3>
        </div>
      </div>
    </div>
  </header>
  ...
  <section class="container p-2">
    ...
    while ($DataRows=$stmt->fetch()) {
          # code...
      $LessonToBeUpdated=$DataRows['title'];
...
$DescriptionToBeUpdated=$DataRows['description'];
    ...
    ?>
    <div class="">
      <form class="p-2" action="EditLesson.php?id=<?php echo $SearchQueryParameter;?>" method="post"
          ...
          <div class="col-lg">
            ...
            <div class="p-2">
              <div class="form-group">
                ...
                <input value="<?php echo $LessonToBeUpdated;?>" type="text" class="form-control"
                name="PostTitle">
              </div>
              <div class="form-group">
                <span>Existing Lesson:<b> <?php echo $LessonToBeUpdated;?></b></span><br></div>
                <label for="category" class="font-weight-bold">
                  <h4>Update Subject</h4>
                </label>
                <select class="form-control" id="CategoryTitle" name="Subject">
                  <?php
                  global $ConnectingDb;
                ...
                <div class="form-group">
                <span>Existing Subject:<b> <?php echo $SubjectToBeUpdated;?></b></span><br><br></div>
              <label for="image" class="font-weight-bold">
                ...
                <div class="custom-file">
                 ...
                 <div class="form-group">
                <span>Existing Image: <b><?php echo $ImageToBeUpdated;?></b></span><br><img src="uploads/<?php echo $ImageToBeUpdated;?>"
                ...
                <div class="form-group">
                  ...
                  <input type="text" data-role="tagsinput"value="<?php echo $TagToBeUpdated;?>" name="tags" class="form-control"style="width: 100%;">
  ...
  # code...
            ...
            <tbody class="text-center">
              <tr>
                ...
                <td><a href="LessonPost.php?lesson=<?php echo $PostTitle ;?>" target="blank"><span
                  class="btn btn-success">L</span></a> <span>/</span>
                  <a href="EditLesson.php?id=<?php echo $Id ;?>" target="blank"><span
                  class="btn btn-success">E</span></a></td>
